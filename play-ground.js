        ...
        ndef.addEventListener('reading', async ({ message }) => {
            if (message.records.length > 0) {
                ...
                if (coinsWallet >= 100) {
                    ...
                    alert(`Welcome to Play Ground, ${studentName}! You have been charged 100 coins.\nPrevious Balance: ${previousCoins} coins\nCurrent Balance: ${updatedCoins} coins`);
                } else {
                    alert(`Sorry, ${studentName}. You don't have enough coins to enter the Play Ground. Your current coin balance is ${coinsWallet}.`);
                }
